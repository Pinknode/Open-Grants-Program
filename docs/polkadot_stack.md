...
| Licensing | [Anagolay Network](https://github.com/anagolay/anagolay-chain) :yellow_circle:| 
| Collection of Pallets | [Substrate Open Runtime Module Library](https://github.com/open-web3-stack/open-runtime-module-library) :green_circle:, [warehouse](https://github.com/galacticcouncil/warehouse) :green_circle:, [InvArch FRAME Pallet Library](https://github.com/InvArch/InvArch-Frames) :red_circle:| 
