...
| Licensing | [Anagolay Network](https://github.com/anagolay/anagolay-chain) :grey_question:| 
| Collection of Pallets | [Substrate Open Runtime Module Library](https://github.com/open-web3-stack/open-runtime-module-library) :yellow_circle:, [warehouse](https://github.com/galacticcouncil/warehouse) :red_circle:, [InvArch FRAME Pallet Library](https://github.com/InvArch/InvArch-Frames) :green_circle:| 
