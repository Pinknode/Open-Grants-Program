...
| Validator payout management | [Substrate validator auto payout](https://github.com/Colm3na/substrate-auto-payout) :red_circle:, [Polkadot Payouts](https://github.com/w3f/polkadot-payouts) :red_circle:, [staking-payouts CLI](https://github.com/emostov/staking-payouts) :red_circle:, [Payctl](https://github.com/stakelink/substrate-payctl) :green_circle:, [crunch](https://github.com/turboflakes/crunch) :green_circle:|
